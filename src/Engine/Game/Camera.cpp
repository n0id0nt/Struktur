...
glm::vec2 Struktur::GameResource::Camera::WorldPosToScreenPos(glm::vec2 worldPos)
{
...
glm::vec2 Struktur::GameResource::Camera::ScreenPosToWorldPos(glm::vec2 screenPos)
{
