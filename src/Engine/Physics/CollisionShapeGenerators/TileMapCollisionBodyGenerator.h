...
void CreateTileMapShape(GameContext& context, const Component::TileMap& tilemap, bool isSensor,
                        Component::PhysicsBody& out_body);

void CreateLoop(Component::PhysicsBody& out_body, Dir inputDir, glm::ivec2 inputTile,
                std::unordered_set<glm::ivec2, IVec2Hash>& checkedTiles, const Component::TileMap& tilemap,
                bool isSensor, const b2Filter& filter, float scale);
