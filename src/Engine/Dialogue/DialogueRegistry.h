...
public:
	...
	void RegisterConditionType(GameContext& context, const std::string& type,
	                           std::unique_ptr<Callback::ICallback> callback);

	// Register command type with Wren callback
	void RegisterCommandType(GameContext& context, const std::string& type,
	                         std::unique_ptr<Callback::ICallback> callback);

	// Register variable type with Wren callback
	void RegisterVariableType(GameContext& context, const std::string& type,
	                          std::unique_ptr<Callback::ICallback> callback);
