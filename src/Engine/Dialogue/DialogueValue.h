...
namespace Struktur::Dialogue
{
	...
	public:
		...
		DialogueValue() : m_value(std::string("")) {}
		explicit DialogueValue(const std::string& s) : m_value(s) {}
		explicit DialogueValue(const char* s) : m_value(std::string(s)) {}
		explicit DialogueValue(int i) : m_value(i) {}
		explicit DialogueValue(bool b) : m_value(b) {}
		explicit DialogueValue(double d) : m_value(d) {}
		...
		const ValueVariant& GetVariant() const { return m_value; }
