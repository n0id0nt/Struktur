...
// name must be one of "vs_sprite", "fs_sprite", "vs_spriteCoverage", "fs_spriteCoverage",
// "vs_richTextAnim", "fs_richTextAnim", "vs_soulEffect", "fs_soulEffect" (the compiled shader names).
