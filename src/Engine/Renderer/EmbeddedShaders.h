...
// caching process-lifetime handles here (never destroyed until shutdown) sidesteps tracking that per-caller,
// which fits this project's small, fixed set of shader uniform names (see ShaderSystem::ApplyUniforms).
