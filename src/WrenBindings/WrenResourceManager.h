...
struct WrenTextureHandle
{
	...
	WrenTextureHandle() {}
	WrenTextureHandle(const Struktur::Resource::ResourcePtr<Struktur::Resource::TextureResource>& res)
	    : resource(res)
	{
	}
};
...
struct WrenShaderHandle
{
	...
	WrenShaderHandle() {}
	WrenShaderHandle(const Struktur::Resource::ResourcePtr<Struktur::Resource::ShaderResource>& res)
	    : resource(res)
	{
	}
};
...
struct WrenFontHandle
{
	...
	WrenFontHandle() {}
	WrenFontHandle(const Struktur::Resource::ResourcePtr<Struktur::Resource::FontResource>& res)
	    : resource(res)
	{
	}
};
...
struct WrenMusicHandle
{
	...
	WrenMusicHandle() {}
	WrenMusicHandle(const Struktur::Resource::ResourcePtr<Struktur::Resource::MusicResource>& res)
	    : resource(res)
	{
	}
};
...
struct WrenSoundHandle
{
	...
	WrenSoundHandle() {}
	WrenSoundHandle(const Struktur::Resource::ResourcePtr<Struktur::Resource::SoundResource>& res)
	    : resource(res)
	{
	}
};
