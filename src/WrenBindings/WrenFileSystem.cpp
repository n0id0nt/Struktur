...
void wren_DialogueManagerReadBytes(WrenVM* vm)
{
    ...
    WrenFileResultByte* wrenResult = static_cast<WrenFileResultByte*>(wrenSetSlotNewForeign(vm, 0, 1, sizeof(WrenFileResultByte)));
...
void wren_DialogueManagerReadString(WrenVM* vm)
{
    ...
    WrenFileResultString* wrenResult = static_cast<WrenFileResultString*>(wrenSetSlotNewForeign(vm, 0, 1, sizeof(WrenFileResultString)));
