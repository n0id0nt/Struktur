...
#define COMPONENT(component_name, component_name_string) 					                                                \
    ...
    {                                                                                                                       \
        ...
        Wren##component_name() : component(nullptr), entity(entt::null) {}                                                  \
        Wren##component_name(entt::entity entity, Struktur::Component::component_name* v) : component(v), entity(entity) {} \
    }; 
    COMPONENT_LIST
#undef COMPONENT