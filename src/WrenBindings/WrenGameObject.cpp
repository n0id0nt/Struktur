...
// GameObject.setParent(entity, parent) -> entityId
void wren_GameObjectSetParent(WrenVM* vm)
{
	Struktur::GameContext* context                     = static_cast<Struktur::GameContext*>(wrenGetUserData(vm));
	Struktur::System::SystemManager& systemManager     = context->GetSystemManager();
	Struktur::System::HierarchySystem& hierarchySystem = systemManager.GetSystem<Struktur::System::HierarchySystem>();
...
// GameObject.setActive(entity)
void wren_GameObjectSetActive(WrenVM* vm)
{
	Struktur::GameContext* context                     = static_cast<Struktur::GameContext*>(wrenGetUserData(vm));
	Struktur::System::SystemManager& systemManager     = context->GetSystemManager();
	Struktur::System::HierarchySystem& hierarchySystem = systemManager.GetSystem<Struktur::System::HierarchySystem>();
...
// GameObject.setInactive(entity)
void wren_GameObjectSetInactive(WrenVM* vm)
{
	Struktur::GameContext* context                     = static_cast<Struktur::GameContext*>(wrenGetUserData(vm));
	Struktur::System::SystemManager& systemManager     = context->GetSystemManager();
	Struktur::System::HierarchySystem& hierarchySystem = systemManager.GetSystem<Struktur::System::HierarchySystem>();
...
{
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "destroy(_)", wren_GameObjectDestroy,
	                  "Destroy an Game Object and all its children.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "create(_,_)", wren_GameObjectCreate,
	                  "Create a new Game Object with the given name and parent. Returns entity ID.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "setParent(_,_)", wren_GameObjectSetParent,
	                  "Create a new Game Object with the given name and parent. Returns entity ID.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "isValid(_)", wren_GameObjectIsValid,
	                  "Check if an entity ID is valid.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "hasComponent(_)", wren_GameObjecthasComponent,
	                  "Checks if entity has a specific component.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "getAllWithComponent(_)",
	                  wren_GameObjectGetAllWithComponent,
	                  "Get all entities with a specific component. Returns list of entity IDs.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "getAllWithComponents(_)",
	                  wren_GameObjectGetAllWithComponents,
	                  "Get all entities with ALL specified components. Pass list of component names.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "getAllWithAnyComponents(_)",
	                  wren_GameObjectGetAnyWithComponents, "Get entities with ANY of the specified components.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "getAll()", wren_GameObjectGetAll,
	                  "Get all entities in the registry. Returns list of entity IDs.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "getAllWithIdentifier(_)",
	                  wren_GameObjectGetAllWithIdentifier,
	                  "Get all entities with a specific identifier. Returns list of entity IDs.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "forEach(_)", wren_GameObjectForEach,
	                  "Iterate all entities, calling callback for each.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "forEachWithComponent(_,_)",
	                  wren_GameObjectForEachWithComponent,
	                  "Iterate entities with component, calling callback for each.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "forEachWithComponents(_,_)",
	                  wren_GameObjectForEachWithComponents,
	                  "Iterate entities with component, calling callback for each.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "forEachWithAnyComponents(_,_)",
	                  wren_GameObjectForEachWithAnyComponents,
	                  "Iterate entities with component, calling callback for each.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "setActive(_)", wren_GameObjectSetActive,
	                  "Sets an entity to acitve.");
	WREN_CLASS_STATIC(registry, "gameObject", "GameObject", "setInactive(_)", wren_GameObjectSetInactive,
