...
inline bool AssertImpl(bool condition, const char* conditionStr, const char* file, int line, const char* func,
...
// Macro definitions
#define DEBUG_LOG(level, ...) Struktur::Debug::Log(level, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
...
#define DEBUG_ERROR(...)                                         \
	DEBUG_LOG(Struktur::Debug::Level::LEVEL_ERROR, __VA_ARGS__); \
	// BREAK
#define DEBUG_FATAL(...)                                        \
	DEBUG_LOG(Struktur::Debug::Level::LEVEL_FATAL, __VA_ARGS__) \
	// BREAK

// Always-on assert (works in both debug and release)
#define ASSERT(condition) Struktur::Debug::AssertImpl(condition, #condition, __FILE__, __LINE__, __FUNCTION__)

#define ASSERT_MSG(condition, ...) \
	Struktur::Debug::AssertImpl(condition, #condition, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)

#define BREAK Struktur::Debug::BreakImpl(__FILE__, __LINE__, __FUNCTION__)

#define BREAK_MSG(...) Struktur::Debug::BreakImpl(__FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
