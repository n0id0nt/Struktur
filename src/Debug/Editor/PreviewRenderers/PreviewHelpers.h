...
namespace Struktur::Debug
{
    ...
    inline void PreviewTexture(PreviewWindow* window, 
                               const Resource::ResourcePtr<Resource::TextureResource>& texture,
    ...
    inline void PreviewShader(PreviewWindow* window, 
                              const Component::Shader* shader, 
                              const std::string& name)
    {
        if (!window) return;
    ...
    inline void PreviewSprite(PreviewWindow* window, 
    ...
    inline void PreviewTextFile(PreviewWindow* window, 
    ...
    inline void PreviewUnknownFile(PreviewWindow* window, 
