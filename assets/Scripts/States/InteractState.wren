...
class InteractState is BaseState {
    ...
    enter() {
        ...
        inventoryBackgroundPanel.setBorderWidth(2)
        ...
        focusedBackgroundPanel.setBorderWidth(2)
        ...
        focusedItemPanel.setBorderWidth(2)
        ...
        for (item in items) {
            ...
            inventoryItemPanel.setBorderWidth(2)
    ...
    exit() {
        ...
        UIManager.removeUIElement(_highlightedItemId)
